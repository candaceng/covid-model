        ...
        <body className="container">
			...
			<p className="walkthrough">
				...
				<ul className="walkthrough">
					<li><span id="variable">S</span> = the number of people susceptible to the disease</li>
					<li><span id="variable">I</span> = the number of people infected</li>
					<li><span id="variable">R</span> = the number of recovered people</li>
				</ul>
				...
				<ul className="walkthrough">
					<li><span id="variable">SStart</span> = 0.99</li>
					<li><span id="variable">IStart</span> = 0.01</li>
					<li><span id="variable">RStart</span> = 0</li>
					<li>time <span id="variable">t</span> as the independent variable</li>
				</ul>
				We then define two adjustable constants that will aid in the derivation of the equations. The first one of which is <span id="variable">transm</span>, 
				which represents the transmission rate of the disease. The equation <span id="variable">S'(t, S, I, R)</span> denotes the rate of change of S with respect 
				...
				of them become infected. The second constant we introduce is <span id="variable"> recov</span>, which represents the recovery rate of infected patients.
				...
				<ul className="walkthrough">
					<li><span id="variable">S'(t, S, I, R) </span>= -(transm)(S)(I)</li>
					<li><span id="variable">I'(t, S, I, R) </span>= (transm)(S)(I) - (recov)(I)</li>
					<li><span id="variable">R'(t, S, I, R) </span>= (recov)(I)</li>
				</ul>
